...
exports.updateVersionPlugin = void 0;
const VERSION_STEP = 1;
const OPERATOR_STRING = '$';
function updateVersionPlugin(schema) {
...
exports.updateVersionPlugin = updateVersionPlugin;
function updateVersioningMiddleware() {
    const options = Object.assign({}, this.getOptions());
    const update = this.getUpdate();
    applyVersioning({ update: update, options, schema: this.model.schema });
}
...
//# sourceMappingURL=update-version.plugin.js.map